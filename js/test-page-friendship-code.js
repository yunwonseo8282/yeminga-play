...
document.addEventListener('DOMContentLoaded', function () {
  var TEST_ID = 'friendship-code';
  var STORAGE_KEY = 'mbuy-friendship-code-progress';
  ...
  introText.innerHTML =
    ...
    '<span class="intro-line intro-line--split">' +
      '<span>사회심리학 기반으로 설계된</span> <span>32가지 우정 유형 중</span>' +
    '</span>' +
  ...
  function showLoading(finalAnswers) {
    ...
    setTimeout(function () {
      var scoreResult  = MBUYScoringFriendshipCode.score(finalAnswers);
      var matchResult  = MBUYScoringFriendshipCode.matchType(scoreResult);
      ...
      var url = '/result/friendship-code.html'
  ...
  startBtn.addEventListener('click', function () {
    ...
    incrementParticipant('friendship-code');
    if (typeof window.gtag === 'function') {
      window.gtag('event', 'test_start', { test_id: 'friendship-code' });
    }
